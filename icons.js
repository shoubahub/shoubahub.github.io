/* ===================================================================
   ...
   ⚠ معيار القبول: أن يقرأ الرمز عند ٢٦px — لا تفاصيل رفيعة.
   ⚠ لا تعدل هذه الملفات بأدوات استبدال نصي (perl/sed): تفسد ترميز العربية.
   =================================================================== */
(function () {
  var I = {};
  ...
  /* الكرة الأرضية: حلقة بخطوط الطول والعرض — اختيار المستخدم (2026-08-20).
     القرص المصمت بخطوط عنبرية كان يقرأ «كرة سلة». */
  ic('globe','كرة أرضية',
  ...
  /* المجهر والرياضيات: أعيدا إلى صورتهما الأولى بطلب المستخدم — أرتب عنده */
  ic('micro','مجهر',
