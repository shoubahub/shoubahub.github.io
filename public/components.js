...
(function () {
  ...
  Shouba.settings = function () {
    ...
    /* ترويسة الورق الرسمي (2026-09-12) — اسطرها وشعار المدرسة على كل مطبوع. والاسم «ترويسة سجلاتك» (2026-09-14): رصد
       المستخدم ان زميلا رفع صورة شعارا ولم يجد اين يغيرها — «اعدادات المطبوعات» لا يدل على الشعار */
    item('ترويسة سجلاتك', 'أسطر الترويسة وشعار المدرسة على الورق', function () {
  ...
  /* ── العودة الى من فتح الشاشة (قاعدة المنصة 2026-09-14، رصد المستخدم في «الملاحظات التربوية»): كان «تم» في السجل
     ...
     المراتب (LEVEL): اللوحة ٠ · التبويبات ١ · ملف المعلم والخطة ٢ · الارشيف ٣ (يفتح من ملف المعلم ايضا: تقارير زياراته)
     · ملف الفصل ٤ · السجل ٥ — ومن فتح الشاشة
