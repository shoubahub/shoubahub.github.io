...
window.SHOUBA_TPL = {
  ...
  hvisit: {
    ...
    /* الاصدار ٢ (2026-09-14، طلب المستخدم — والاول منشور فلا يمس، وتقاريره تعرض به):
       · «الحصة التي زرتها» (slot): حصص المعلم اليوم اولا، ثم يدويا من فصوله وحصصه في جدوله — لا تتبع تاريخ الزيارة
         فتصلح لزيارة قديمة (rec-form slotPicker) · «المادة» في سطر الزيارة («لتعدد اسماء المواد في كل شعبة»)
